...
public class RnnModuleSample extends ReactContextBaseJavaModule implements MediaPlayer.OnPreparedListener {

    ReactApplicationContext reactContext;
    MediaPlayer mMediaPlayer;

    public RnnModuleSample(ReactApplicationContext reactContext) {
        super(reactContext);
